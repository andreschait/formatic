#formatic [![Build Status](https://secure.travis-ci.org/andreschait/formatic.png?branch=master)](http://travis-ci.org/andreschait/formatic) [![devDependency Status](https://david-dm.org/andreschait/formatic/dev-status.png?branch=master)](https://david-dm.org/andreschait/formatic#info=devDependencies&view=table)
...
4. [angular-validator](https://github.com/andreschait/angular-validator)
